...
reload("ai-assistant.sessions.session-manager")
reload("ai-assistant.sessions.openai")
reload("ai-assistant.profiles")
reload("ai-assistant.profiles.pair-programmer")
reload("ai-assistant.runner")
...
require("ai-assistant.runner")["run-with-buf"](1,"pair-programmer")
